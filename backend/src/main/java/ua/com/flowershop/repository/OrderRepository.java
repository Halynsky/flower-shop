...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    Page<OrderAdminProjection> findForAdminProjectedByFilters(Long id, List<String> statusNames, String userNamePart, String userFacebookNicknamePart, String phonePart,
