...
public interface WarehouseOperationRepository extends JpaRepository<WarehouseOperation, Long> {
    ...
    @Query("SELECT wo FROM WarehouseOperation wo WHERE " +
        ...
        "AND (COALESCE(:flowerTypeNames, NULL) IS NULL OR wo.flowerSize.flower.flowerType.name IN :flowerTypeNames) " +
    ...
    Page<WarehouseOperationProjection> findProjectedByFilters(Long id, List<String> flowerTypeNames, String flowerNamePart, String flowerSizeNamePart,
