...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT u.id as id, u.name as name, u.email as email, u.role as role, u.isEnabled as isEnabled, u.isVirtual as isVirtual FROM User u " +
    ...
    Page<UserAdminProjection> findProjectedBy(Long id, String namePart, String emailPart, Pageable pageable);
